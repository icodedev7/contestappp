...
redirect_to "https://devlopment-store.myshopify.com/admin/oauth/authorize?client_id=2797f1bc7e2ae87a08fb90f0713f1712&scope=read_products,write_themes,write_script_tags&redirect_uri=https://devlopment-store.myshopify.com/admin/apps/contestappp&state=Callback"
  end
