...
redirect_to "https://#{params[:shop].gsub(".myshopify.com","")}.myshopify.com/admin/oauth/authorize?client_id=2797f1bc7e2ae87a08fb90f0713f1712&scope=read_products,read_orders,read_customers&redirect_uri=https://#{params[:shop].gsub(".myshopify.com","")}.myshopify.com/admin/apps&state=Callback"
