...
redirect_to "https://devlopment-store.myshopify.com/admin/oauth/authorize?client_id=#{SHOPIFY_API_KEY}&scope=read_products,write_themes,write_script_tags,read_orders,read_customers&redirect_uri=#{REDIRECT_URI}&state=Callback"
  end
