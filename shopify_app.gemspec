...
Gem::Specification.new do |s|
  ...
  config.api_key = ENV['2797f1bc7e2ae87a08fb90f0713f1712']
  config.secret = ENV['756bbb6132cc61ad450e5b1bd2e0f411']
  config.redirect_uri = "<%= https://devlopment-store.myshopify.com/admin/apps %>"
